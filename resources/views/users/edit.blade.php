                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="nivel" id="nivel" class="form-control" required>
                                <option value="1" {{ old('nivel', $usuario->nivel) == 1 ? 'selected' : '' }}>Administrador</option>
                                <option value="2" {{ old('nivel', $usuario->nivel) == 2 ? 'selected' : '' }}>Subadmin</option>
                                <option value="3" {{ old('nivel', $usuario->nivel) == 3 ? 'selected' : '' }}>Cliente</option>
                                <option value="4" {{ old('nivel', $usuario->nivel) == 4 ? 'selected' : '' }}>Sócio</option>
                                <option value="5" {{ old('nivel', $usuario->nivel) == 5 ? 'selected' : '' }}>Funcionário</option>
                                <option value="6" {{ old('nivel', $usuario->nivel) == 6 ? 'selected' : '' }}>Operador</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 campo-legado campo-apoio">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                name="id_apoio"
                                class="form-control"
                                value="{{ old('id_apoio', $usuario->id_apoio) }}"
                            >
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 campo-legado campo-porcentagem">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                name="porcentagem"
                                class="form-control"
                                value="{{ old('porcentagem', $usuario->porcentagem) }}"
                            >
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 campo-legado campo-pais">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                name="id_pais"
                                class="form-control"
                                value="{{ old('id_pais', $usuario->id_pais) }}"
                            >
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 campo-legado campo-validade">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                name="validade"
                                class="form-control"
                                value="{{ old('validade', optional($usuario->validade)->format('Y-m-d')) }}"
                            >
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 campo-legado campo-afiliado">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                name="afiliado"
                                class="form-control"
                                value="{{ old('afiliado', $usuario->afiliado) }}"
                            >
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 campo-legado campo-fechar-faturas">
                        <div class="form-group">
                            ...
                            <select name="fechar_faturas_ponto" class="form-control">
                                <option value="0" {{ old('fechar_faturas_ponto', $usuario->fechar_faturas_ponto) == 0 ? 'selected' : '' }}>Não</option>
                                <option value="1" {{ old('fechar_faturas_ponto', $usuario->fechar_faturas_ponto) == 1 ? 'selected' : '' }}>Sim</option>
                            </select>
                        </div>
                    </div>
